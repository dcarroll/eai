...
const messages = Messages.loadMessages('eai:vision', 'predict');

export default class VisionPredict extends SfdxCommand {
  ...
  public async run(): Promise<AnyJson> {
    ...
    const path: string = 'https://api.einstein.ai/v2/vision/predict/';
